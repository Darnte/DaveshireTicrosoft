        ...
        <div className="flex items-center justify-between h-10 text-sm">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <div className="flex items-center space-x-2 hover:text-white/80 transition-colors text-white">
              ...
              <span className="text-white">+447780173325</span>
            </div>
            <div className="flex items-center space-x-2 hover:text-white/80 transition-colors text-white">
              <Mail className="w-3 h-3 text-white" />
              <span className="text-white">davidobawole@gmail.com</span>
            </div>
            <div className="flex items-center space-x-2 hover:text-white/80 transition-colors text-white">
              <MapPin className="w-3 h-3 text-white" />
              <span className="text-white">Cardiff, Wales, United Kingdom</span>
            </div>
          </div>
