        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="font-montserrat font-bold text-xl text-white">DaveshireTicrosoft</span>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-sm">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">davidobawole@gmail.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="w-4 h-4 text-gray-400" />
                <span className="text-gray-300">+447780173325</span>
              </div>
              <div className="flex items-center space-x-3">
                <MapPin className="w-4 h-4 text-gray-400" />
                <span className="text-gray-300">Cardiff, Wales, United Kingdom</span>
              </div>
            </div>
          </div>
        </div>
