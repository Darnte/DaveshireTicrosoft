  ...
  const services = [
    {
      ...
      description: "Building a comprehensive, long-term plan that guides all aspects of a brand",
      features: ["Unique value proposition (UVP)", "Competitive analysis", "Brand differentiation", "Brand identity and personality"],
    ...
    },
    {
      ...
      description: "Encapsulating copywriting, design, and production that provide value and connect you to your target audience.",
      features: ["Goal setting", "Content planning", "Content audit", "Performance analysis"],
      color: "text-blue-600",
      bgColor: "bg-blue-50",
    ...
    },
    {
      ...
      description: "Monitoring performance, interacting with users, and implementing strategies to increase brand awareness, loyalty, and overall business impact.",
      features: ["Content calendar", "Content library", "AI-powered tools", "Design tools"],
    ...
    },
    {
      ...
      description: "Coordinating across channels, tracking performance in real-time, and analyzing results to inform future campaigns. ",
      features: ["Campaign planning", "Audience segmentation", "Budget allocation", "Content calendar"],
    ...
    },
    {
      ...
      description: "Evaluate a company's current online presence, identifies performance gaps, and builds tailored solutions that align with business goals.",
      features: ["Data-driven", "Customer-centric", "Ongoing Support", "Skill development"],
      color: "text-red-600",
      bgColor: "bg-red-50",
      href: "/training",
    },
    {
      icon: Search,
      title: "Website Copywritying & SEO Optimization",
