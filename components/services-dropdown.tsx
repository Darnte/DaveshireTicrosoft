  ...
  const services = [
    {
      ...
      description: "Control how business is viewed by customers",
      href: "/strategy",
    },
    {
      icon: Search,
      name: "Content Creation & Creative Direction",
      description: "Connect a brand to its prospective audience",
      href: "/content-creation",
    },
    {
      icon: Search,
      name: "Social Media Management & Growth",
      description: "Creating and publishing content to build a brand's online presence",
      href: "/socials-mgt",
    },
    {
      icon: Search,
      name: "Campaign Management & Execution",
      description: "Managing a series of marketing campaigns",
      href: "/campaign-mgt",
    },
    {
      icon: Search,
      name: "Training & Consulting",
      description: "Strategic advice to empower internal teams",
      href: "/training",
    },
    {
      icon: Search,
      name: "Website Copywriting & SEO Optimization",
